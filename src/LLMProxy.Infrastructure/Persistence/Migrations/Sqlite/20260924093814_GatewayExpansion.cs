    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                ActualCost = table.Column<decimal>(type: "TEXT", precision: 20, scale: 9, nullable: false),
                Actor = table.Column<string>(type: "TEXT", maxLength: 160, nullable: false),
                CreatedAt = table.Column<long>(type: "INTEGER", nullable: false)
            },
            constraints: table =>
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Purpose = table.Column<string>(type: "TEXT", maxLength: 24, nullable: false),
                Content = table.Column<string>(type: "TEXT", nullable: true),
                BatchId = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
                ErrorsOnly = table.Column<bool>(type: "INTEGER", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                ActualCost = table.Column<decimal>(type: "TEXT", precision: 20, scale: 9, nullable: true)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                CustomId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: false),
